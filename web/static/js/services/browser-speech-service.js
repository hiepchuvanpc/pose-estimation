export class BrowserSpeechService {
  ...
  speak(messages, clearQueue = false, onEndCallback = null, options = null) {
    const opts = options && typeof options === "object" ? options : {};
    const rate = Number.isFinite(opts.rate) ? opts.rate : 1.0;
    const onStartLast = typeof opts.onStartLast === "function" ? opts.onStartLast : null;
